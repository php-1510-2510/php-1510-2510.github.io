...
5. **(6 points)** Plot and Describe the Distribution of Mental Health Days off. 
...
9. **(12 points)** Display graphs of variables that have relationships with Mental Health Days off.  (**Note:** Look at the notes with general health to see how to combine multiple plots in a larger grid image. (lect 13 slide 58) )
...
10. **20 points** We have been exploring the outcome of days off due to mental health. Papers have been published suggesting that there is a relationship between transgender and mental health. Some of this comes from the fact that there are higher transgender suicide attempts. 
